...
import { Mic, MicOff, Video, VideoOff, Send, Phone, PhoneOff, Loader2, Settings, Volume2, X, ChevronDown, Plus, Trash2, MessageSquareText, MessageSquare, Camera, Image as ImageIcon, Film, Download, Eye, Bookmark, Check, FileText, Edit3, Save, History, Folder as FolderIcon } from 'lucide-react';
...
Active Note ID: ${activeNoteId || 'None'}`,
  ...
  return (
    <div className={`relative flex flex-col h-full w-full overflow-hidden transition-colors duration-500 ${isConnected ? 'bg-black' : 'bg-red-600'}`}>
      ...
      <AnimatePresence>
        {children && (
          <motion.div 
            ...
            exit={{ opacity: 0, y: -20 }}
            className="absolute top-0 left-0 right-0 h-[70%] z-50 bg-neutral-900 border-b border-neutral-800 flex flex-col shadow-2xl overflow-hidden"
          >
            {children}
          </motion.div>
        )}
      ...
      <div className="p-4 bg-neutral-950 border-t border-neutral-800 flex flex-col gap-4 relative z-[70] shrink-0 min-h-[140px]">
